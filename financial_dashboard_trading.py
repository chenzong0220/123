...
if choice == choices[0] :         ##'台積電: 2022.1.1 至 2024.4.9':
    df_original = load_data('KBar_CMF_2023-04-17_To_2025-04-17.pkl')
    product_name = '台新金期貨'
...
if choice == choices[1] :                   ##'大台指期貨2024.12到期: 2023.12 至 2024.4.11':
    df_original = load_data('KBar_CQF_2023-04-17_To_2025-04-17.pkl')
    product_name = '統一期貨'
if choice == choices[2] :                              ##'小台指期貨2024.12到期: 2023.12 至 2024.4.11':
    df_original = load_data('KBar_CCF_2023-04-17_To_2025-04-16.pkl')
    product_name = '聯電期貨'
if choice == choices[3] :                                           ##'英業達2020.1.2 至 2024.4.12':
    df_original = load_data('KBar_CEF_2023-04-15_To_2025-04-16.pkl')
    product_name = '富邦金期貨'
if choice == choices[4] :                                                       ##'堤維西2020.1.2 至 2024.4.12':
    df_original = load_data('KBar_CBF_2023-04-17_To_2025-04-17.pkl')
    product_name = '中鋼期貨'
